...
### Streamlit Community Cloud (recommande)

1. Pousser le code sur un depot GitHub
2. Se connecter a [share.streamlit.io](https://share.streamlit.io)
3. Selectionner le depot, la branche et `app.py` comme fichier principal
4. L'application est deployee automatiquement
